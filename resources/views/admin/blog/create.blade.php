                            ...
                            @csrf
                              ...
                              <div class="row mb-3">
                                  <div class="col-xl-6">
                                    ...
                                    <input type="text" value="{{ old('backend_tech') }}" name="backend_tech" class="form-control" id="backend_tech" placeholder="Backend Technology...">
                                  ...
                                  <div class="col-xl-6">
                                    ...
                                    <input type="text" value="{{ old('frontend_tech') }}" name="frontend_tech" class="form-control" id="frontend_tech" placeholder="Frontend Technology...">
                              ...
                              <div class="mb-3">
                                ...
                                <textarea name="description" id="description" cols="15" rows="5" class="form-control" placeholder="Description...">{{ old('description') }}</textarea>
